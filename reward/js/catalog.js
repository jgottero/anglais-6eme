...
const CATALOG = (function () {
  ...
  const ITEMS = [
    ...
    // ---------- animals ----------
    { id: "chicken", fr: "Poule",  en: "a hen",    price: 60,  w: 2, h: 2, mirrors: true, category: "animals", asset: "chicken.svg" },
    { id: "duck",    fr: "Canard", en: "a duck",   price: 70,  w: 2, h: 2, mirrors: true, category: "animals", asset: "duck.svg" },
    { id: "rabbit",  fr: "Lapin",  en: "a rabbit", price: 80,  w: 2, h: 2, mirrors: true, category: "animals", asset: "rabbit.svg" },
    { id: "cat",     fr: "Chat",   en: "a cat",    price: 90,  w: 2, h: 2, mirrors: true, category: "animals", where: "both", asset: "cat.svg" },
    { id: "dog",     fr: "Chien",  en: "a dog",    price: 110, w: 2, h: 2, mirrors: true, category: "animals", where: "both", asset: "dog.svg" },
    { id: "sheep",   fr: "Mouton", en: "a sheep",  price: 150, w: 2, h: 2, mirrors: true, category: "animals", asset: "sheep.svg" },
    { id: "cow",     fr: "Vache",  en: "a cow",    price: 220, w: 4, h: 2, mirrors: true, category: "animals", asset: "cow.svg" },
    { id: "horse",   fr: "Cheval", en: "a horse",  price: 300, w: 4, h: 2, mirrors: true, category: "animals", asset: "horse.svg" },

    // ---------- nature ----------
    { id: "flowers",    fr: "Fleurs",     en: "flowers",        price: 30,  w: 2, h: 2, mirrors: true, category: "nature", asset: "flowers.svg" },
    { id: "wheat",      fr: "Blé",        en: "wheat",          price: 35,  w: 2, h: 2, category: "nature", asset: "wheat.svg" },
    { id: "mushroom",   fr: "Champignon", en: "a mushroom",     price: 40,  w: 2, h: 2, mirrors: true, category: "nature", asset: "mushroom.svg" },
    { id: "pumpkin",    fr: "Citrouille", en: "a pumpkin",      price: 45,  w: 2, h: 2, mirrors: true, category: "nature", asset: "pumpkin.svg" },
    { id: "bush",       fr: "Buisson",    en: "a bush",         price: 50,  w: 2, h: 2, mirrors: true, category: "nature", asset: "bush.svg" },
    { id: "pine_tree",  fr: "Sapin",      en: "a pine tree",    price: 170, w: 4, h: 4, category: "nature", asset: "pine-tree.svg" },
    { id: "apple_tree", fr: "Pommier",    en: "an apple tree",  price: 190, w: 4, h: 4, mirrors: true, category: "nature", asset: "apple-tree.svg" },
    { id: "pond",       fr: "Mare",       en: "a pond",         price: 260, w: 4, h: 4, mirrors: true, category: "nature", asset: "pond.svg" },
    ...
    { id: "mailbox",      fr: "Boîte aux lettres",  en: "a mailbox",       price: 60,  w: 2, h: 2, mirrors: true, category: "garden", asset: "mailbox.svg" },
    ...
    { id: "plant",     fr: "Plante",         en: "a plant",      price: 70,  w: 2, h: 2, mirrors: true, category: "furniture", where: "in", asset: "plant.svg" },
    { id: "table",     fr: "Table",          en: "a table",      price: 140, w: 4, h: 2, turns: true, category: "furniture", where: "in", asset: "table.svg" },
    { id: "bookshelf", fr: "Bibliothèque",   en: "a bookcase",   price: 150, w: 2, h: 2, turns: true, mirrors: true, category: "furniture", where: "in", asset: "bookshelf.svg" },
    { id: "wardrobe",  fr: "Armoire",        en: "a wardrobe",   price: 170, w: 2, h: 2, turns: true, category: "furniture", where: "in", asset: "wardrobe.svg" },
    { id: "sink",      fr: "Évier",          en: "a sink",       price: 180, w: 2, h: 2, turns: true, mirrors: true, category: "furniture", where: "in", asset: "sink.svg" },
    { id: "stove",     fr: "Cuisinière",     en: "a cooker",     price: 200, w: 2, h: 2, turns: true, category: "furniture", where: "in", asset: "stove.svg" },
    { id: "fridge",    fr: "Réfrigérateur",  en: "a fridge",     price: 220, w: 2, h: 2, turns: true, mirrors: true, category: "furniture", where: "in", asset: "fridge.svg" },
    ...
    { id: "inner_door", fr: "Porte",          en: "a door",       price: 90,  w: 2, h: 1, turns: true, mirrors: true, category: "furniture", where: "in", asset: "inner-door.svg" },

    // ---------- buildings ----------
    { id: "coop",       fr: "Poulailler", en: "a chicken coop", price: 450, w: 6, h: 4, turns: true, mirrors: true, category: "buildings", asset: "coop.svg" },
