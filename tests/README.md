...
Quarante-sept suites Playwright qui ouvrent vraiment les pages dans un
...
npm test             # les quarante-sept, dans l'ordre
npm test -- 47       # une seule
npm test -- 30-47    # une tranche
```
