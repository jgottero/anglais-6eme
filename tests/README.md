...
Quarante-neuf suites Playwright qui ouvrent vraiment les pages dans un
...
npm test             # les quarante-neuf, dans l'ordre
npm test -- 49       # une seule
npm test -- 30-49    # une tranche
```
