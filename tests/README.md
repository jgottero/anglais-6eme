...
Quarante-huit suites Playwright qui ouvrent vraiment les pages dans un
...
npm test             # les quarante-huit, dans l'ordre
npm test -- 48       # une seule
npm test -- 30-48    # une tranche
```
