...
Quarante-six suites Playwright qui ouvrent vraiment les pages dans un
...
npm test             # les quarante-six, dans l'ordre
npm test -- 46       # une seule
npm test -- 30-46    # une tranche
```
