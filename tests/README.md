...
Quarante-quatre suites Playwright qui ouvrent vraiment les pages dans un
...
npm test             # les quarante-quatre, dans l'ordre
npm test -- 44       # une seule
npm test -- 30-44    # une tranche
```
