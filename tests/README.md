...
Quarante-deux suites Playwright qui ouvrent vraiment les pages dans un
...
npm test             # les quarante-deux, dans l'ordre
npm test -- 42       # une seule
npm test -- 30-42    # une tranche
```
