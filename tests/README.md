...
Quarante-cinq suites Playwright qui ouvrent vraiment les pages dans un
...
npm test             # les quarante-cinq, dans l'ordre
npm test -- 45       # une seule
npm test -- 30-45    # une tranche
```
