...
Quarante-trois suites Playwright qui ouvrent vraiment les pages dans un
...
npm test             # les quarante-trois, dans l'ordre
npm test -- 43       # une seule
npm test -- 30-43    # une tranche
```
