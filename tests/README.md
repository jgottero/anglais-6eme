...
Cinquante-deux suites Playwright qui ouvrent vraiment les pages dans un
...
npm test             # les cinquante-deux, dans l'ordre
npm test -- 52       # une seule
npm test -- 30-52    # une tranche
```
